document.getElementById('ReporteTotalContenedores').addEventListener('click', function(event){
    event.preventDefault();

    fetch('https://esenttiapp-production.up.railway.app/api/exceltotalcontenedores')
    .then(response=>{
        if(!response.ok){
