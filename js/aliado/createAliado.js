...
const columnDefs = [
    ...
    { headerName: "Tipo documento", field: "tipo_documento" },
    { headerName: "identificacion", field: "identificacion" },
    { headerName: "Estudio Seguridad", field: "estudio_seg" },
    {
        headerName: "Acciones",
        cellRenderer: params => {
    ...
    .then(data => {
        const processedData = data.map(aliado => {
            return {
                ...
                estudio_seg: aliado.estudio_seg,
            };
        });
