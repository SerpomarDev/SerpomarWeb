window.addEventListener('headerLoaded', () => {
    ...
    if (logo && sidebar) {
        ...
        console.error("No se pudo encontrar el logo o el sidebar");
    }
    ...
    function mostrarModalInicioSesion() {
        ...
        btnIniciarSesion.onclick = function() {
            logoutUser(); // Llamar a la función logoutUser de logout.js
            forceLogout(); // Asumiendo que forceLogout está definida en otro lugar
        }

        // Mostrar el modal
        modalauditor.style.display = "block";
    }
